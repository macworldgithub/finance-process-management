...
export const financialAssertionsData = [
  {
    ...
    internalControlOverFinancialReporting: "Yes",
    occurrence: true,
    completeness: true,
    accuracy: true,
    authorization: true,
    cutoff: true,
    classificationUnderstandability: true,
    existence: true,
...
export const internalAuditData: DataType[] = [
  { key: "1", no: "5.1", process: "Establishing Account Receivable", internalAuditTest: "To inquiry establishment of Account Receivable procedure is usually performed together with other procedures, such as inspecting the supporting documents or observing the client’s staff performing the controls, in order to ensure that the explanation given by the client’s staff or management is true.", check: "", sampleSize: "" },
  { key: "2", no: "5.2", process: "Establishment of Account Receivable Control Devices", internalAuditTest: "Reviewed", check: "", sampleSize: "" },
  { key: "3", no: "5.3", process: "Returns and allowances from customer", internalAuditTest: "Check the appropriate Returns Receiving Report to see if the invoice number is listed. If the entire invoice is being returned, there is no need to call on the invoice, as the customer will not be paying it. If only part of the invoice is returned, and call the customer to find out the payment status of the remaining balance.", check: "", sampleSize: "" },
  { key: "4", no: "5.4", process: "Offer Discount and allowance on Accounts Receivable collection", internalAuditTest: "Review the sales discount report and match with company credit terms and company discount policy and obtain on the customer list, who availed the discount sample basis and perform analytical procedure to find inconsistency if any in the customer individual accounts. ", check: "", sampleSize: "" },
  { key: "5", no: "5.5", process: "Estimate the Accounts Receivable Aging Analysis", internalAuditTest: "An auditor will use several techniques to determine whether the allowance for doubtful accounts appears reasonable. Most begin with the company’s aging schedule. The older a receivable is, the harder it will be to collect.", check: "", sampleSize: "" },
  { key: "6", no: "5.6", process: "Assessing the Allowance for Doubtful Accounts", internalAuditTest: "Thoroughly review allowance computations to see if they are consistent with prior years; compare allowance percentages to industry averages; agree to supporting documentation (e.g., histories of uncollectible amounts); recompute the related numbers. ", check: "", sampleSize: "" },
  { key: "7", no: "5.7", process: "Sending statement of account to the customers", internalAuditTest: "Obtain the statement of accounts and match with customer individual ledger account on sample basis and ensure the accuracy. ", check: "", sampleSize: "" },
  { key: "8", no: "5.8", process: "Cash Receipts from Customers", internalAuditTest: "Periodically trace a selection of cash receipts to customer invoices to verify proper cash application.", check: "", sampleSize: "" },
  { key: "9", no: "5.9", process: "Preparation of the Account Receivable Voucher Package", internalAuditTest: "Obtain the sample of Account Receivable and vouch them to the supporting documents, such as customer orders and sales invoices.", check: "", sampleSize: "" },
  { key: "10", no: "5.10", process: "Procedures Performed on Account Receivable Voucher Package", internalAuditTest: "Check the authorized approval of Account Receivable voucher package and related general account distribution and Perform Account Receivable confirmation on a sample of customer", check: "", sampleSize: "" },
  { key: "11", no: "5.11", process: "Review accounts receivable journal entries", internalAuditTest: "Review on sample basis whether Sales invoice is approved and recorded in Voucher Register or Sales Journal by the authorized person.", check: "", sampleSize: "" },
  { key: "12", no: "5.12", process: "Reconciliation of Account Receivable Sub-ledger to Account Receivable General Ledger", internalAuditTest: "Assessment of accounts receivable reconciliation statement on a sample basis to verify agreement between accounts receivable subsidiary ledger and receivable general ledger account (control account).  ", check: "", sampleSize: "" }
];