  ...
  const data: DataType[] = [
    {
      ...
      // Process tab data
      processDescription: "Process for establishing account receivable",
      processObjective: "To ensure accurate recording of receivables",
      ...
      operationalUnit: "Finance Operations",
      division: "Accounting",
      entity: "Main Entity",
      unitDepartment: "AR Department",
    ...
    },
    {
      ...
      processDescription: "Control devices for AR management",
      processObjective: "To implement control mechanisms",
      processSeverityLevels: "Medium",
    ...
    },
    {
      ...
      processDescription: "Process for handling customer returns",
      processObjective: "To manage returns efficiently",
      processSeverityLevels: "Low",
      activity: "Sales Return",
      process2: "Voucher Processing",
      stage: "Processing",
      functions: "Finance",
      clientSegment: "Corporate",
      operationalUnit: "Sales Operations",
      division: "Sales",
      entity: "Main Entity",
      unitDepartment: "Sales Department",
      productClass: "Services",
      productName: "Support",
      integrityEthical: true,
      boardOversight: true,
    ...
    },
    {
      key: "4",
      no: "5.4",
      process: "Returns and allowances fr..",
      processDescription: "Discount and allowance processing",
      processObjective: "To provide customer discounts",
      processSeverityLevels: "Medium",
    ...
    },
    {
      ...
      processDescription: "AR collection discount process",
      processObjective: "To incentivize early payments",
      processSeverityLevels: "High",
    ...
    },
    {
      ...
      processDescription: "AR aging analysis estimation",
      processObjective: "To assess receivable aging",
      processSeverityLevels: "High",
    ...
    },
    {
      ...
      processDescription: "Assessment of doubtful accounts",
      processObjective: "To estimate bad debt",
      processSeverityLevels: "Medium",
    ...
    },
    {
      ...
      processDescription: "Allowance assessment process",
      processObjective: "To review allowances",
      processSeverityLevels: "Low",
      activity: "Account Receivable Processing",
    ...
    },
    {
      ...
      processDescription: "Statement sending process",
      processObjective: "To communicate account status",
      processSeverityLevels: "Medium",
    ...
    },
    {
      ...
      processDescription: "Cash receipt processing",
      processObjective: "To record cash receipts",
      processSeverityLevels: "High",
      activity: "Vouching",
      process2: "A/R Aging Analysis Process",
      stage: "Processing",
    ...
    },
    {
      ...
      processDescription: "Voucher package preparation",
      processObjective: "To prepare AR vouchers",
      processSeverityLevels: "Medium",
      activity: "Vouching",
      process2: "A/R Aging Analysis Process",
      stage: "Processing",
    ...
    },
    {
      ...
      processDescription: "Voucher package procedures",
      processObjective: "To execute voucher procedures",
      processSeverityLevels: "Low",
